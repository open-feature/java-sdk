...
class FlagEvaluationOptionsTest {
    ...
    void getHooks_shouldReturnDefensiveCopy() {
        List<Hook<?>> originalHooks = List.of(new TestHook("hook1"));
        ...
        assertThatThrownBy(() -> originalHooks.add(new TestHook("hook3")))
    ...
    void builder_shouldSetHooksList() {
        List<Hook<?>> hooks = List.of(new TestHook("hook1"), new TestHook("hook2"));
    ...
    void builder_shouldOverrideHooksListWhenSetAfterIndividualHooks() {
        ...
        List<Hook<?>> hooksList = List.of(new TestHook("list1"), new TestHook("list2"));
    ...
    void builder_shouldAddToExistingHooksAfterList() {
        List<Hook<?>> hooksList = List.of(new TestHook("list1"));
