...
<p align="center" class="github-badges">
  ...
  <a href="https://github.com/open-feature/java-sdk/releases/tag/v1.7.7">
    <img alt="Release" src="https://img.shields.io/static/v1?label=release&message=v1.7.7&color=blue&style=for-the-badge" />
  </a>  
...
```groovy
dependencies {
    implementation 'dev.openfeature:sdk:1.7.7'
}
```
<!-- x-release-please-end-version -->
