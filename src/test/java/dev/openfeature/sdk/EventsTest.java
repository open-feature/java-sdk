...
class EventsTest {
        ...
        class NamedProvider {
            ...
            class Initialization {
                ...
                void apiInitReady() {
                    ...
                    var provider =
                            TestProvider.builder().initWaitsFor(INIT_DELAY).isReady();
    ...
    class NamedProvider {
        ...
        class Initialization {
            ...
            void initReadyProviderBefore() {
                ...
                var provider = TestProvider.builder().initWaitsFor(INIT_DELAY).isReady();
                Client client = api.getClient(name);
            ...
            void initErrorProviderAfter() {
                ...
                var provider = TestProvider.builder().initWaitsFor(INIT_DELAY).isInError();
                Client client = api.getClient(name);
    ...
    void shouldNotRunHandlers() {
        ...
        var provider1 = TestProvider.builder().initWaitsFor(INIT_DELAY).isReady();
        var provider2 = TestProvider.builder().initWaitsFor(INIT_DELAY).isReady();
    ...
    void boundShouldNotRunWithDefault() {
        ...
        var namedProvider = TestProvider.builder().initWaitsFor(INIT_DELAY).isReady();
        var defaultProvider = TestProvider.builder().initWaitsFor(INIT_DELAY).isReady();
